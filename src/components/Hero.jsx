        ...
        >
          ...
          >
            ...
            {isLoadingLeetcode ? (
              ...
              <>
                <span className="text-blue-400 font-semibold">Knight</span>
          ...
          >
            ...
            <span className="text-blue-400 font-bold">1700+</span>
          </a>
          ...
          <a
            href="https://drive.google.com/file/d/1FsrJ9cA7nbWRvG7sRwN89J9b9El06dzE/view?usp=sharing" target="_blank"
            className="group flex items-center gap-2 bg-slate-800/40 backdrop-blur-sm border border-gray-500/30 rounded-full px-4 py-2 hover:border-gray-400 hover:bg-slate-800/60 transition-all duration-300 hover:scale-105"
          >
